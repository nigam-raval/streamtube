...
const createLike = asyncHandler(async (req, res) => {
  ...
  return res.status(200).json(new ApiResponse(200, like, 'like is added successfully'))
})
...
const getPostLike = asyncHandler(async (req, res) => {
  ...
  return res.status(200).json(new ApiResponse(200, response, 'get post like successfully'))
})

export { createLike, deleteLike, getPostLike }
